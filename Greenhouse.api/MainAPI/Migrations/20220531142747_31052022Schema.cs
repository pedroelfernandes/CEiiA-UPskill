...
{
    public partial class _31052022Schema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetSensors", x => new { x.AssetId, x.SensorId });
                    table.ForeignKey(
                        name: "FK_AssetSensors_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssetSensors_Sensors_SensorId",
                        column: x => x.SensorId,
